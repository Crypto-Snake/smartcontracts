...
import "../interfaces/IBEP1155MetadataURI.sol";
 ...
 */
contract SnakeArtifactsNFT is Allowable, IBEP1155, IBEP1155MetadataURI, Initializable, TokenStorage {
    ...
    function uri(uint256 id) public view virtual override returns (string memory) {
        return nftManager.getArtifactProperties(id).URI;
    }
    ...
    function balanceOf(address account, uint256 id) public view virtual override returns (uint256) {
        require(account != address(0), "SnakeArtifactsNFT: balance query for the zero address");
    ...
    {
        require(accounts.length == ids.length, "SnakeArtifactsNFT: accounts and ids length mismatch");
    ...
    function mint(
        ...
        uint256 amount,
        bytes memory data
    ) external virtual override onlyAllowedAddresses {
        require(to != address(0), "SnakeArtifactsNFT: mint to the zero address");
    ...
    function mintBatch(
        ...
        require(to != address(0), "SnakeArtifactsNFT: mint to the zero address");
        require(ids.length == amounts.length, "SnakeArtifactsNFT: ids and amounts length mismatch");
    ...
    function burn(
        ...
        require(from != address(0), "SnakeArtifactsNFT: burn from the zero address");
        ...
        require(fromBalance >= amount, "SnakeArtifactsNFT: burn amount exceeds balance");
        unchecked {
    ...
    function safeTransferFrom(
        ...
        require(
            ...
            "SnakeArtifactsNFT: caller is not owner nor approved"
        );
    ...
    function _safeTransferFrom(
        ...
        require(to != address(0), "SnakeArtifactsNFT: transfer to the zero address");
        ...
        uint256 fromBalance = _balances[id][from];
        require(fromBalance >= amount, "SnakeArtifactsNFT: insufficient balance for transfer");
        unchecked {
            _balances[id][from] = fromBalance - amount;
        }
        _balances[id][to] += amount;
